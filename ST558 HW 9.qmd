...
# 
# # Tibble for plotting
# rf_var_imp_df <- tibble(
#   term = names(rf_final_model$variable.importance),
#   value = as.numeric(rf_final_model$variable.importance)
# )
# 
# # Reorder term by importance
# rf_var_imp_df <- rf_var_imp_df |>
#   arrange(value) |>
#   mutate(term = factor(term, levels = term))  # Keep order for plotting
# 
# 
# ggplot(rf_var_imp_df, aes(x = term, y = value)) +
#   geom_bar(stat = "identity") +
#   coord_flip() +
