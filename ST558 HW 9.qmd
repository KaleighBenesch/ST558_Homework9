...
## LASSO Model
Add to your previous document where you fit multiple linear regression models using 10 fold cross-validation.
You should add (using the first recipe):
  • a (tuned) LASSO model (note: I got all the same RMSE values for every tuning value)
